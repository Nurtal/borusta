/// Rust benchmark on the Wine dataset.
/// Run: cargo run --release --bin bench_wine
...
fn main() {
    let (x, y, feat_names) = load_csv("benchmark/wine.csv");
    ...
    println!("=== boruta-rs (Wine, {} iterations, {:.3}s) ===",
